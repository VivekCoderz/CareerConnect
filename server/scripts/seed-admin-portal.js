...
async function seedAdminPortal() {
  ...
  if (!superAdmin) {
    ...
    superAdmin.password = "TestAdminPassword123!";
  ...
  if (legacyAdmin) {
    ...
    legacyAdmin.password = "TestAdminPassword123!";
  ...
  if (!techCorpAdmin) {
    ...
    techCorpAdmin.password = "TestAdminPassword123!";
  ...
  if (!innovateAdmin) {
    ...
    innovateAdmin.password = "TestAdminPassword123!";
  ...
  console.log(`   Password: TestAdminPassword123!`);

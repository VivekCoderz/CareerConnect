...
async function runAcceptanceTests() {
  ...
  try {
    const res = await login("superadmin@careerconnect.com", "TestAdminPassword123!");
  ...
  let techCorpToken = "";
  try {
    const res = await login("techcorp.admin@careerconnect.com", "TestAdminPassword123!");
  ...
  const superRes = await login("superadmin@careerconnect.com", "TestAdminPassword123!");

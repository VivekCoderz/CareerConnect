      ...
      >
        ...
        <div className="flex justify-between items-center pb-4 border-b border-slate-100">
          ...
          <button
            type="button"
            onClick={onClose}
            className="w-8 h-8 rounded-full bg-slate-100 text-slate-500 hover:bg-slate-200 hover:text-slate-800 flex items-center justify-center text-sm font-bold transition"
        ...
        {/* Hero Card */}
        <div className="p-6 sm:p-8 rounded-3xl bg-gradient-to-r from-purple-800 via-indigo-900 to-slate-900 text-white space-y-4 shadow-lg shadow-purple-900/20">
            ...
            <div className="flex items-center gap-4">
              {user?.profileImage || profile?.profileImage ? (
                ...
                <div className="w-16 h-16 rounded-2xl bg-white/20 text-white font-black text-2xl flex items-center justify-center border border-white/30">
                  {user?.fullName?.charAt(0) || profile?.fullName?.charAt(0) || "P"}
                </div>
              )}
              <div>
        ...
        <div className="flex justify-end pt-3 border-t border-slate-100">
          <button
            type="button"
            onClick={onClose}
            className="px-6 py-2.5 rounded-xl bg-slate-900 text-white text-xs font-bold hover:bg-slate-800 transition shadow-xs"
          >
            Close Preview
          </button>
        </div>

...
const NAV_ITEMS = [
  ...
  { id: "recommendations", label: "Career Recommendations", icon: "M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" },
...
const FresherSidebar = ({ activeTab, onSelectTab, mobileOpen, onCloseMobile, onLogout }) => {
  return (
    <>
      {/* Mobile Backdrop */}
      {mobileOpen && (
      ...
      >
        ...
        <div>
          <div className="h-16 px-6 flex items-center justify-between border-b border-slate-100">
            <Link to="/fresher/dashboard" className="flex items-center gap-2.5">
              ...
              <div>
                ...
                <span className="block text-[10px] font-semibold text-[#f59e0b] tracking-wider uppercase">Fresher Hub</span>
              </div>
            </Link>
            <button
              onClick={onCloseMobile}

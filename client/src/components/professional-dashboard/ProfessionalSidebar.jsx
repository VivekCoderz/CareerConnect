      ...
      >
        ...
        <div className="flex flex-col flex-1 overflow-hidden">
          <div className="h-16 px-4 sm:px-5 flex items-center justify-between border-b border-slate-100 shrink-0">
            ...
            >
              <div className="w-9 h-9 rounded-xl bg-purple-600 flex items-center justify-center font-bold text-white shadow-md shadow-purple-600/30 text-base shrink-0">
                C
              </div>
              {!collapsed && (

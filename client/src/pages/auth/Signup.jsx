...
const Signup = () => {
  ...
  const handleGoogleSignup = async () => {
    ...
    try {
      const captchaToken =
        await getCaptchaToken("google_signup");
      ...
      if (requiresPasswordSetup) {
        ...
        navigate(
          getDashboardPath(user.userType, user),
          {
            replace: true,
          }
        );
  ...
  const handleSubmit = async (e) => {
    ...
    if (!emailVerified) {
      dispatch(
        signupFailure("Please verify your email first")
      );
      return;
    }
    ...
    try {
      ...
      const dest =
        userType === "fresher"
          ? "/fresher/profile"
          : getDashboardPath(
              res.data.user?.userType || userType,
              res.data.user
            );
        ...
        <div className="hidden lg:flex w-[42%] bg-gradient-to-br from-[#1e3a8a] via-[#1e40af] to-[#172554] text-white p-12 flex-col justify-between relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            >
              ...
              <div>
                ...
                <p className="text-[11px] text-[#fbbf24] font-semibold">
                  CareerConnect
                </p>
              </div>
            </Link>
          ...
          <div className="relative z-10">
            ...
            <p className="text-blue-100/90 text-[15px] leading-relaxed max-w-sm">
              Join Geeta University’s official platform
              for internships, jobs and career growth.
            </p>
          </div>
      ...
      >
        ...
        >
            ...
            >
              ...
              <div className="space-y-4">
                ...
                <p className="text-center text-[11px] text-slate-500">
                  {emailVerified
                    ? "✓ Email verified. Click continue to proceed."
                ...
                <p className="text-center text-[11px] text-slate-400">
                  Google sign-up creates your account & will ask
            ...
            >
              ...
              <div className="mb-8 text-center">
                ...
                <p className="text-sm text-slate-500 mt-2">
                  Select the option that matches your current
                  stage
                </p>
              </div>
                ...
                {[
                  {
                    id: "student",
                    title: "Student",
                    desc: "Currently studying and looking for internships or early opportunities.",
                  },
                  {
                    id: "fresher",
                    title: "Fresher",
                    desc: "Recently graduated and ready to start your professional career.",
                  },
                  {
                    id: "professional",
                    title: "Working Professional",
                    desc: "Already working and looking for better roles or growth.",
                  },
                ].map((item) => (
                  <button
                    key={item.id}
          ...
          {step === 3 && emailVerified && (
            <div
              key="step3"
              className={`${slideClass} max-w-md mx-auto`}
            >
              <button
                onClick={() => goBack(2)}
                className="text-sm text-slate-500 hover:text-slate-700 mb-6 flex items-center gap-1"
                  ...
                  <>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={handleChange}
                        placeholder="Enter course name (e.g. B.Tech Computer Science)"
                  ...
                  <>
                    <div>
                      ...
                      <input
                        ...
                        onChange={handleChange}
                        placeholder="Enter qualification (e.g. B.Tech / BCA / MCA)"
                        className={inputClass(
                          "highestQualification"
                        )}
                      />
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={handleChange}
                          placeholder="Enter industry (e.g. IT, Finance)"
                          className={inputClass(
                            "industry"
                          )}
                        />

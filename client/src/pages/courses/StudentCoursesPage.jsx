    ...
    <div className="space-y-6">
      ...
      <div className="border-b border-slate-200 pb-5">
        ...
        <p className="text-xs text-slate-500 mt-1">
          Explore recommended LMS courses, apply for
          enrollments, and complete video/notes curriculum.
        </p>
      </div>
      ...
      <div className="flex items-center gap-1.5 bg-slate-100 p-1.5 rounded-2xl border border-slate-200/80">
        ...
        >
          <ShieldCheck size={14} />
          <span>
            My Courses ({myApplications.length})
          </span>
        </button>
          ...
          <div className="p-6 sm:p-8 rounded-3xl bg-gradient-to-br from-[#1e3a8a] via-[#1e40af] to-indigo-900 text-white shadow-md relative overflow-hidden">
            ...
            <div className="relative z-10 max-w-3xl space-y-2">
              ...
              <span className="px-3 py-1 rounded-full bg-white/20 text-[11px] font-extrabold text-amber-300 uppercase tracking-wider border border-white/20 inline-flex items-center gap-1.5">
                <Sparkles size={13} />
                CareerConnect Skill Recommendations
              </span>
              ...
              <p className="text-xs sm:text-sm text-blue-100/90 leading-relaxed">
                ...
                {studentSkillsList.length > 0 ? (
                  <>
                    Recommended courses matched against
                    your profile skills (
                    ...
                    ). Apply for courses to unlock
                    video lectures, study notes, and
                    certificates.
                  </>
                ) : (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              {filteredCourses.map((course) => (
                ...
                <CourseCard
                  ...
                  course={course}
                  matchedSkills={
                    course.matchedSkills || []
                  }
                  applicationStatus={getCourseStatus(
                    course._id
                  )}
                  onViewDetails={(id) => {
                  ...
                  onApply={(courseData) =>
                    handleOpenApplyModal(courseData)
                  }
                  onContinueLearning={() => {
                    setActiveTab("my-courses");
                  }}
